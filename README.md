# 📱 Infinite Reel-Style Quotes App

A **mobile-first infinite scrolling reel interface** inspired by **Instagram Reels** and **YouTube Shorts**, built using **pure HTML, CSS, and JavaScript**.

Each quote appears as a **full-screen vertical reel**, loaded dynamically from an API with **smooth scroll snapping, silent background preloading, and light animations**.
